...
class AppSettings:
    ...
    language: str = "zh-CN"
    ui_scale: float = 1.0
    close_behavior: str = "minimize"  # minimize / exit
    float_card_enabled: bool = False
    float_card_always_on_top: bool = True
    show_on_startup: bool = True
    proxy: ProxyConfig = field(default_factory=ProxyConfig)
    data_dir: str = ""
    auto_refresh_interval: int = 30  # 分钟
    auto_switch_enabled: bool = False
    auto_switch_threshold: float = 10.0  # 剩余积分阈值
